...
export const EVIDENCE_JSONL_RELATIVE_PATH =
  `${CANONICAL_LEARNINGS_ROOT}/evidence.jsonl`;
export const LESSONS_JSONL_RELATIVE_PATH =
  `${CANONICAL_LEARNINGS_ROOT}/lessons.jsonl`;
